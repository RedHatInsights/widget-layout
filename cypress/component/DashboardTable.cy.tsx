...
describe('DashboardTable', () => {
  ...
  it('renders dashboard rows with correct data', () => {
    ...
    cy.get('tbody tr').eq(0).within(() => {
      ...
      cy.get('td[data-label="Last Modified"]').should('contain.text', '5 Feb 2025 09:15 UTC');
    });
    ...
    cy.get('tbody tr').eq(1).within(() => {
      ...
      cy.get('td[data-label="Last Modified"]').should('contain.text', '10 Mar 2025 16:45 UTC');
    });
    ...
    cy.get('tbody tr').eq(2).within(() => {
      ...
      cy.get('td[data-label="Last Modified"]').should('contain.text', '15 Jan 2025 14:30 UTC');
    });
  });
