...
const IntegrationsIcon = () => {
  return (
    <svg className="service-icon" viewBox="0 0 48 48">
      <defs>
        <style>
          {`
            .cls-1 {
